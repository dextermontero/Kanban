    ...
    <div class="py-4 rounded-lg dark:border-gray-700 mt-14">
        <div class="flex flex-row justify-between items-center mb-5">
            <a href="{{ route('auth.projects') }}" class="mb-2 inline-flex items-center justify-center group">
                ...
                <h2 class="text-gray-100 text-3xl font-medium tracking-wider group-hover:text-gray-300">Project Name</h2>
            </a>
        </div>
            ...
            <div class="grid grid-cols-3 gap-4 mb-4">
                <div class="bg-gray-800 rounded flex flex-col">
                    <div class="flex flex-col xl:flex-row items-center justify-between px-5 py-2.5">
                        ...
                        <div class="flex flex-col items-center justify-center mt-1 xl:mt-0">
                            <h2 class="text-gray-100 text-2xl xl:text-3xl leading-relaxed font-bold font-mono mr-2 xl:mr-0">200K</h2>
                ...
                <div class="bg-gray-800 rounded flex flex-col">
                    <div class="flex flex-col xl:flex-row items-center justify-between px-5 py-2.5">
                        ...
                        <div class="flex flex-col items-center justify-center mt-1 xl:mt-0">
                            <h2 class="text-gray-100 text-2xl xl:text-3xl leading-relaxed font-bold font-mono mr-2 xl:mr-0">190K</h2>
                ...
                <div class="bg-gray-800 rounded flex flex-col">
                    <div class="flex flex-col xl:flex-row items-center justify-between px-5 py-2.5">
                        ...
                        <div class="flex flex-col items-center justify-center mt-1 xl:mt-0">
                            <h2 class="text-gray-100 text-2xl xl:text-3xl leading-relaxed font-bold font-mono mr-2 xl:mr-0">1M</h2>
        ...
        <div class="relative bg-gray-800 rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 space-y-4">
                <form action="" method="">
                    ...
                    <div class="mt-3">
                        {{-- <button type="submit" class="mt-2 block w-full rounded-md bg-blue-600 font-md font-medium text-gray-200 hover:bg-blue-700 px-2 py-2.5 tracking-wider">Create Project</button> --}}
                    </div>
                </form>
            </div>
        </div>
