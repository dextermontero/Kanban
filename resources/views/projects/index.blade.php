                ...
                <form action="" method="">
                    ...
                    <div class="grid grid-cols-1 xl:grid-cols-2 gap-4">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" id="endDate" name="endDate" class="bg-gray-600 border border-gray-500 text-gray-200 text-md focus:ring-gray-700 focus:border-gray-700 block rounded-lg w-full placeholder-gray-200" placeholder="End Date">
                        </div>
                    </div>
                    <div class="mt-3">
