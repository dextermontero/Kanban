...
<div class="p-4 xl:ml-64">
    <div class="py-4 rounded-lg dark:border-gray-700 mt-14">
        <div class="flex flex-col xl:flex-row justify-start xl:justify-between items-start xl:items-center mb-5">
            <div class="mb-2">
                <h2 class="text-gray-100 text-3xl font-medium tracking-wider">Project Workstation</h2>
            </div>
        </div>
        @if ($count > 0)
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-4 mb-4">
                @foreach ($list as $project)
                    <a href="{{ route('auth.workstation', $project->uuid) }}" class="min-h-[6rem] block rounded bg-gray-800 dark:bg-gray-800 p-4 hover:cursor-pointer border border-gray-800 hover:border-gray-400">
                        <div class="flex items-center justify-between mb-4">
                            <h2 class="text-2xl font-medium text-gray-200 tracking-wide">{{ ucwords($project->project_name) }}</h2>
                        </div>
                        <div class="mb-4">
